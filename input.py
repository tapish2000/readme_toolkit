...
if is_install_req in ('y', 'yes'):
    ...
    if install_desc == "":
        ...
        install_steps.append(str(i) + ". " + install_desc + "\n\t```\n\t" + install_code + "\n\t```\n")
while((is_install_req in ('y', 'yes')) and install_code.lower() != 'quit' and install_desc.lower() != 'quit'):
...
if is_descr_required in ('y', 'yes'):
    ...
    unique_thing = input("Unique ideas in this project which is worth mentioning [type \"quit\" to stop entering\
         or keep writing ]: \n1.  ")
    i = 1
...
lines.append("The author of this repository is " + name + ". Explore more about the author and find related things [here]\
(" + website_link + "). ")
lines.extend(acks)
lines.append("\n")
...
lines.append("First fork this repo then clone it into your system. Pull requests are welcome. For major changes, please open an \
